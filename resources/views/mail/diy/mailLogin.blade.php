...
<head>
    ...
    <style>
        ...
        /* Subtle text style from the target template */
        .subtle-text {
        ...
        /* Button Styles (can also be inlined) */
        .button {
            background-color: #4A90E2; /* Match header blue */
            color: #ffffff;
            padding: 12px 25px;
        ...
        <tr>
            <td align="center" style="padding: 30px 15px;">
                <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%; max-width: 600px; background-color: #ffffff; margin: 0 auto; border-radius: 12px; overflow: hidden;">
                    ...
                    <tbody>
                        <tr>
                            <td style="padding: 35px 30px 15px 30px;"> <h1 style="font-size: 22px; line-height: 1.4; color: #333333; margin-bottom: 25px;">
                                    登入到 {{$name}}
                                </h1>
                                ...
                                <p style="color: #555555; font-size: 15px; line-height: 1.6; margin-bottom: 1em;">
                                    您正在尝试登入到 {{$name}}。请在 <strong>5 分钟</strong> 内点击下方按钮完成登入操作：
                                </p>
                            </td>
                        </tr>
                         <tr>
                            <td class="button-td" style="padding: 10px 30px 20px 30px; text-align: center;">
                                <a href="{{$link}}" target="_blank" class="button" style="background-color: #4A90E2; color: #ffffff; padding: 12px 25px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: bold; text-align: center; border: none;">
                                    点击这里登入
                                </a>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0px 30px 25px 30px;"> <p class="subtle-text" style="font-size: 13px; color: #888888; line-height: 1.6; text-align: center; margin:0;"> 如果您未请求此次登入，请忽略本邮件。
                                </p>
                            </td>
                        </tr>
                    </tbody>
